...
import { Commission, HelpArticle, Settings, Transaction, User, type SettingsDoc, type ObjectId } from "@/models";

// VIP defaults modelled on 9K-style tiers (PKR). Admin can edit in panel.
export const DEFAULT_VIP = [
  { level: 0, name: "Bronze", minDeposit: 0, dailyWithdrawLimit: 5000, perWithdrawMax: 5000, minWithdraw: 500 },
  { level: 1, name: "Silver", minDeposit: 300, dailyWithdrawLimit: 15000, perWithdrawMax: 10000, minWithdraw: 500 },
  { level: 2, name: "Gold", minDeposit: 1000, dailyWithdrawLimit: 30000, perWithdrawMax: 20000, minWithdraw: 500 },
  { level: 3, name: "Platinum", minDeposit: 5000, dailyWithdrawLimit: 60000, perWithdrawMax: 40000, minWithdraw: 500 },
  { level: 4, name: "Diamond", minDeposit: 20000, dailyWithdrawLimit: 150000, perWithdrawMax: 100000, minWithdraw: 500 },
  { level: 5, name: "Royal", minDeposit: 50000, dailyWithdrawLimit: 300000, perWithdrawMax: 200000, minWithdraw: 500 },
  { level: 6, name: "Legend", minDeposit: 150000, dailyWithdrawLimit: 1000000, perWithdrawMax: 500000, minWithdraw: 500 },
];
