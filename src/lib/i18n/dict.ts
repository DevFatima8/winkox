...
const en = {
  ...
  appDownload: "APP Download", getApp: "Get the WinX555 app", getAppSub: "Android & iPhone — open directly from home screen, get notifications.",
  ...
  marquee: [
"Welcome to WinX555! Register and get PKR 1500 welcome bonus",
...
"3 random red packets daily — chance to win up to PKR 888,888",
  ...
  changePassword: "Change Password", appTitle: "WinX555 App", appNote: "Install the app on your phone — open directly from home screen.", supportChannels: "Support & Channels",
  ...
  supportTitle: "WinX555 Live Support", onlineAgent: "Online — agent available", offlineHours: "Offline · Hours {h}", typeMessage: "Type a message...", autoReply: "Auto reply",
...
const ur: Dict = {
  ...
  appDownload: "ایپ ڈاؤن لوڈ", getApp: "WinX555 ایپ حاصل کریں", getAppSub: "اینڈرائیڈ اور آئی فون — ہوم اسکرین سے براہِ راست کھولیں، نوٹیفکیشنز پائیں۔",
  ...
  marquee: [
"WinX555 میں خوش آمدید! رجسٹر کریں اور PKR 1500 ویلکم بونس حاصل کریں",
...
"روزانہ 3 رینڈم ریڈ پیکٹس — PKR 888,888 تک جیتنے کا موقع",
  ...
  changePassword: "پاس ورڈ تبدیل کریں", appTitle: "WinX555 ایپ", appNote: "فون پر ایپ انسٹال کریں — ہوم اسکرین سے براہِ راست کھولیں۔", supportChannels: "سپورٹ اور چینلز",
  ...
  supportTitle: "WinX555 لائیو سپورٹ", onlineAgent: "آن لائن — ایجنٹ دستیاب", offlineHours: "آف لائن · اوقات {h}", typeMessage: "پیغام لکھیں...", autoReply: "خودکار جواب",
