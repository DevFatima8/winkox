...
export type CommissionDoc = Base & { beneficiaryId: string; fromUserId: string; kind: "deposit" | "bet" | "signup" | "referral"; baseAmount: number; pct: number; amount: number; note: string };
