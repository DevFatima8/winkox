...
export default function PayPageClient({ params, searchParams }: { params?: Record<string, string>; searchParams?: Record<string, string> }) {
  ...
  return (
    <div className="wx-bg min-h-screen text-white">
      <header className="flex items-center justify-between border-b border-[#3a2470] px-4 py-3"><Logo size="sm" /><Link href="/client/wallet" className="text-xs text-[#b8a7e6] hover:text-white">← Wallet</Link></header>
