    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex gap-2">
          ...
          {canSee && <form action={toggleUserActiveAction.bind(null, id, !u.isActive)}><button className={`rounded-lg px-3 py-1.5 text-xs font-bold ${u.isActive ? "bg-red-500/15 text-red-300" : "bg-emerald-500/15 text-emerald-300"}`}>{u.isActive ? "Block account" : "Unblock"}</button></form>}
