...
export default function AdminDashboardClient({ params, searchParams }: { params?: Record<string, string>; searchParams?: Record<string, string> }) {
  ...
  const [totalUsers, todayUsers, dep, wd, pending, accActive, balAgg, resAgg] = await Promise.all([
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap gap-2">
        {(me.level >= 2
          ...
          : [["/admin/support", "Live Support"], ["/admin/transactions", "Deposits & Withdraws"], ["/admin/notifications", "Send Notification"], ["/admin/records", "Records"], ["/admin/account", "My Account"]]
      ...
      <div className="grid gap-4 md:gap-6 xl:grid-cols-2">
        ...
        <Card title="Pending Deposits / Withdraws" action={<Link href="/admin/transactions" className="text-sm text-yellow-400">Manage →</Link>}>
