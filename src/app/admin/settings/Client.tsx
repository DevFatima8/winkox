    ...
    return (
      <div className="space-y-6">
        ...
        <SettingsForm s={{
          ...
          referral: { depositCommissionPct: s.referral?.depositCommissionPct ?? 2, betCommissionPct: s.referral?.betCommissionPct ?? 1.5, signupBonus: s.referral?.signupBonus ?? 0, referralDepositBonus: s.referral?.referralDepositBonus ?? 288, agentDepositCommissionPct: s.referral?.agentDepositCommissionPct ?? 8 },
