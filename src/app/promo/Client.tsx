...
const PROMOS = [
  ...
  { icon: "👥", title: "Invite & Earn 588 PKR", desc: "1 dost ko invite karein jo top-up kare — 588 PKR bonus, plus 1.5% betting commission aur 4% top-up commission.", tag: "Invite", id: "invite" },
...
const PROMOS_UR: Record<string, [string, string]> = {
  ...
  "Invite & Earn 588 PKR": ["انوائٹ کریں اور 588 PKR کمائیں", "1 دوست کو انوائٹ کریں جو ٹاپ اپ کرے — 588 PKR بونس، ساتھ 1.5% بیٹنگ کمیشن اور 4% ٹاپ اپ کمیشن۔"],
